...
export default function OffersSystem() {
  ...
  // Find campaigns linked to each offer
        ...
        {offers.items.map((offer) => {
          ...
          return (
            <div key={offer.id} className="offer-card" style={{
              ...
              {/* Two-column layout: Definition + Deployment */}
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
                {/* Left: What is this offer */}
                <div>
              ...
              {/* Where This Is Live — linked campaigns */}
              <div style={{ marginTop: 14, paddingTop: 12, borderTop: "1px solid var(--border)" }}>
                <div className="section-header" style={{ marginBottom: 6 }}>
                  <div className="section-dot" style={{ background: stage?.color || "var(--accent)" }} />
