...
// Entities: Campaign, FunnelRows, Moments, Tasks, Creatives, Channels, Offers, Insights, Inspiration
...
export const FUNNEL_ROWS_DEFAULTS = [
  {
    ...
    message: "Golf is growing, but not for everyone. The lifestyle is visible, but access is limited.",
    contentDirection: "Short-form hooks, teaser videos, curiosity-driven content",
    keyLines: "Golf is growing… but for who? | You can see it everywhere, but you can't access it.",
  },
  {
    id: "fr-2", stage: "awareness",
    message: "You can see it everywhere, but you can't access it. Something doesn't make sense.",
    contentDirection: "Problem-awareness shorts, organic social posts",
    keyLines: "Something about this doesn't make sense. | The lifestyle is visible, but access isn't.",
  },
  {
    id: "fr-3", stage: "awareness",
    message: "The best brands don't sell to you. Access is controlled.",
    contentDirection: "Gate-expose video series, mic-drop clips",
    keyLines: "The best brands don't sell to you. | Access is controlled.",
  },
  {
    ...
    contentDirection: "Explainers, problem-focused content, landing pages",
    keyLines: "It's not that you don't belong. You were never invited. | The same insiders, every time.",
  },
  {
    id: "fr-5", stage: "consideration",
    message: "We built something different. No gates. No handshakes required.",
    contentDirection: "Product reveal, brand story, social proof",
    keyLines: "We built something different. | No gates. No handshakes required.",
  },
  {
    id: "fr-6", stage: "conversion",
    message: "Same level of product. Different level of access. This is open now.",
    contentDirection: "Offer-driven ads, product + value content, retargeting",
    keyLines: "Same level of product. Different level of access. | This is where the game is going.",
  },
  {
    id: "fr-7", stage: "conversion",
    message: "Join the club. Access, unlocked. Welcome to the new club.",
    contentDirection: "Urgency creative, founding member offer, strong CTA",
    keyLines: "This is open now. | Join the club. | Access, unlocked.",
  },
  {
    id: "fr-8", stage: "retention",
    message: "You are part of something better. Member benefits, community, ongoing value.",
    contentDirection: "Onboarding sequence, benefits content, engagement loops",
    keyLines: "You are part of something better. | Welcome to the new club.",
  },
  {
    id: "fr-9", stage: "retention",
    message: "Share your experience. Refer others. Grow the movement.",
    contentDirection: "UGC campaigns, referral program, testimonials",
    keyLines: "Share your experience. | Refer others. | Grow the movement.",
  },
];
...
export const CREATIVES_DEFAULTS = [
  { id: "c-1", angle: "Golf is gated", format: "video", hook: "Golf is growing… but for who?", status: "not_started", performance: "", owner: "", deadline: "", platform: "tiktok", caption: "", fileUrl: "", linkedMoment: "m-1", linkedCampaign: "camp-2", notes: "" },
  { id: "c-2", angle: "Golf is gated", format: "video", hook: "You can see it everywhere, but you can't access it.", status: "not_started", performance: "", owner: "", deadline: "", platform: "meta", caption: "", fileUrl: "", linkedMoment: "m-1", linkedCampaign: "camp-1", notes: "" },
  { id: "c-3", angle: "Golf is gated", format: "video", hook: "The best brands don't sell to you.", status: "not_started", performance: "", owner: "", deadline: "", platform: "tiktok", caption: "", fileUrl: "", linkedMoment: "m-1", linkedCampaign: "camp-2", notes: "" },
  { id: "c-4", angle: "Golf is gated", format: "video", hook: "Access is controlled. The same people get the best deals.", status: "not_started", performance: "", owner: "", deadline: "", platform: "meta", caption: "", fileUrl: "", linkedMoment: "m-1", linkedCampaign: "camp-1", notes: "" },
  { id: "c-5", angle: "Why do insiders pay less?", format: "video", hook: "It's not that you don't belong. You were never invited.", status: "not_started", performance: "", owner: "", deadline: "", platform: "tiktok", caption: "", fileUrl: "", linkedMoment: "m-2", linkedCampaign: "", notes: "" },
  { id: "c-6", angle: "Why do insiders pay less?", format: "image", hook: "Value comparison: Country Club vs Mully", status: "not_started", performance: "", owner: "", deadline: "", platform: "meta", caption: "", fileUrl: "", linkedMoment: "m-3", linkedCampaign: "camp-4", notes: "" },
  { id: "c-7", angle: "You're seeing it, but not getting it", format: "video", hook: "Something about this doesn't make sense.", status: "not_started", performance: "", owner: "", deadline: "", platform: "tiktok", caption: "", fileUrl: "", linkedMoment: "m-1", linkedCampaign: "", notes: "" },
  { id: "c-8", angle: "You're seeing it, but not getting it", format: "email", hook: "The system is broken. Here's how.", status: "not_started", performance: "", owner: "", deadline: "", platform: "email", caption: "", fileUrl: "", linkedMoment: "m-2", linkedCampaign: "camp-5", notes: "" },
  { id: "c-9", angle: "Golf isn't built for you — until now", format: "video", hook: "We built something different. No gates. No handshakes required.", status: "not_started", performance: "", owner: "", deadline: "", platform: "youtube", caption: "", fileUrl: "", linkedMoment: "m-2", linkedCampaign: "camp-3", notes: "" },
  { id: "c-10", angle: "Golf isn't built for you — until now", format: "video", hook: "Same level of product. Different level of access.", status: "not_started", performance: "", owner: "", deadline: "", platform: "meta", caption: "", fileUrl: "", linkedMoment: "m-3", linkedCampaign: "camp-4", notes: "" },
  { id: "c-11", angle: "Golf isn't built for you — until now", format: "image", hook: "This is where the game is going.", status: "not_started", performance: "", owner: "", deadline: "", platform: "meta", caption: "", fileUrl: "", linkedMoment: "m-3", linkedCampaign: "", notes: "" },
  { id: "c-12", angle: "You don't need status to play at a higher level", format: "video", hook: "This is open now. Join the club.", status: "not_started", performance: "", owner: "", deadline: "", platform: "tiktok", caption: "", fileUrl: "", linkedMoment: "m-5", linkedCampaign: "", notes: "" },
  { id: "c-13", angle: "You don't need status to play at a higher level", format: "video", hook: "Access, unlocked. Welcome to the new club.", status: "not_started", performance: "", owner: "", deadline: "", platform: "meta", caption: "", fileUrl: "", linkedMoment: "m-5", linkedCampaign: "camp-4", notes: "" },
  { id: "c-14", angle: "You don't need status to play at a higher level", format: "email", hook: "Premium golf, accessible. Here's your invite.", status: "not_started", performance: "", owner: "", deadline: "", platform: "email", caption: "", fileUrl: "", linkedMoment: "m-5", linkedCampaign: "camp-5", notes: "" },
  { id: "c-15", angle: "Golf is gated", format: "video", hook: "Mic-drop moment — This is why we built Mully.", status: "not_started", performance: "", owner: "", deadline: "", platform: "youtube", caption: "", fileUrl: "", linkedMoment: "m-2", linkedCampaign: "camp-3", notes: "" },
];
...
export const CAMPAIGNS_DEFAULTS = [
  {
    ...
    linkedOffer: "", linkedMoment: "m-1", kpiTarget: "CTR > 2%, CPM < $12",
  ...
  },
  {
    ...
    linkedOffer: "", linkedMoment: "m-1", kpiTarget: "10k views/video, 5% engagement",
    performance: "", status: "not_started",
    startDate: "", endDate: "",
  },
  {
    ...
    linkedOffer: "", linkedMoment: "m-2", kpiTarget: "Watch time > 60%, 1k views",
    performance: "", status: "not_started",
    startDate: "", endDate: "",
  },
  {
    ...
    linkedOffer: "o-3", linkedMoment: "m-5", kpiTarget: "CVR > 4%, CPA < $35",
    performance: "", status: "not_started",
    startDate: "", endDate: "",
  },
  {
    ...
    linkedOffer: "o-1", linkedMoment: "m-5", kpiTarget: "Open > 35%, Click > 8%",
    performance: "", status: "not_started",
    startDate: "", endDate: "",
  },
  {
    ...
    linkedOffer: "o-2", linkedMoment: "m-2", kpiTarget: "50 signups/location",
    performance: "", status: "not_started",
    startDate: "", endDate: "",
  },
  {
    ...
    linkedOffer: "o-4", linkedMoment: "m-7", kpiTarget: "20 UGC posts",
    performance: "", status: "not_started",
    startDate: "", endDate: "",
  },
];
...
export const INSPIRATION_DEFAULTS = [
  { id: "ins-1", title: "Dollar Shave Club Launch Video", url: "https://www.youtube.com/watch?v=ZUG9qYTJMsI", type: "video", tags: ["humor", "disruption", "launch"], notes: "Perfect tone for challenger brand. Low budget, massive impact." },
  { id: "ins-2", title: "Liquid Death — Don't Be Scared", url: "https://www.youtube.com/watch?v=ri8mBSGkjNE", type: "video", tags: ["branding", "irreverent", "anti-corporate"], notes: "Water brand that made boring product rebellious. Tone reference." },
  { id: "ins-3", title: "Gymshark Community Content Strategy", url: "", type: "article", tags: ["ugc", "community", "growth"], notes: "How they built a brand on community-first content and athlete partnerships." },
];
